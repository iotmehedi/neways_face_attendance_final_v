                    ...
                    child: Stack(
                      children: [
                        Padding(
                          ...
                          child: _employeeController.capturedImage.value != null &&
                            ...
                            child: ClipRRect(
                              ...
                              _employeeController.cameraController != null &&
                              _employeeController.cameraController!.value.isInitialized
                              ? Container(
                            // height: MediaQuery.of(context).size.height * 0.6,
                            // width: MediaQuery.of(context).size.width,
                            decoration: BoxDecoration(
                            ...
                            child: ClipRRect(
                              ...
                              child: CameraPreview(_employeeController.cameraController!),
                            ),
                          )
                              : Container(
                            height: MediaQuery.of(context).size.height * 0.6,
                                ...
                                Expanded(
                                  child: Center(
                                    child: CustomSimpleText(
                                      text: "Image already taken. Now processing.....",
